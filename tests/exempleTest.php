 ...
 */
 ...
 // Require the file that contains our file to test.
...
class Test extends TestCase {
	...
	// All test functions need to strat with test- and something after.
	...
	public function testContentsOfDatabaseConfig() {
		...
		foreach($properies as $property) {
			// in PHPUnit Attribute is equal to Property, it's the same thing.
